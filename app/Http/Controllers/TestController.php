...
class TestController extends Controller
{
    ...
    public function individual(Request $request)
    {
        ...
        /*--- lead create code---- */
        $curl = curlResponse($lead_data, $token, Config::get("constants.base_URL") . Config::get("constants.create_lead_API_name"),Config::get("constants.curlopt_httpheader.individual_dual_browser_id"));
    ...
    public function dual(Request $request)
    {
        ...
        if ($http_status == Config::get('constants.status_error_code')) {
            return redirect(url()->previous() . '#dual')->with('error', $d_response['message']);
        }
    ...
    public function gifting(Request $request)
    {
        ...
        $validatedData = [
            'Emailgift' => 'required|email|unique:customer',
		...
		if ($http_status == Config::get('constants.status_error_code')) {
            return redirect(url()->previous() . '#gifting')->with('error', $lead_datas['message']);
		}
    ...
    public function check(Request $request)
    {
        ...
        $id = $all['subscription']['id'] == '' ? '' : $all['subscription']['id'];
        print_r($id);
    }
}
