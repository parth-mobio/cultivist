          ...
          <div class="row">
            ...
            <div class="tabs-wrap tabs-style-1 pt-3">
                ...
                @foreach($datas as $key => $value)
	                ...
	                @elseif($value['handle'] == 'museum-2')
	                	<li class="nav-item" role="presentation">
                    		<a class="nav-link {{session('activeTab') == 'dual' ? 'active' : ''}}" id="dual-tab" data-bs-toggle="tab" href="#dual" role="tab" aria-controls="dual" aria-selected="false">Dual Membership<span class="d-none d-sm-inline"></span></a>
                  		</li>
	                @else
	                	<li class="nav-item" role="presentation">
                ...
                @if($value['handle'] == 'museum-1')	
                  	<div class="tab-pane fade {{session('activeTab') == '' ? 'show active' : ''}}" id="individual" role="tabpanel" aria-labelledby="individual-tab">
	                    <div class="form-wrap">
		                    ...
		                    <form method="post" action="{{URL::asset('individual-post')}}" id="contact_form">
		                        ...
		                        <input type="hidden" name="product_handle" value="{{$value['handle']}}">
	                    ...
	                    <div class="tabs-style-1 mt-4">
	                    	<?php
			                  		$price = ($value['price_in_cents']/ 100);
			                ?>
			                <input type="hidden" name="product_price" id="pro_price" value="{{$price}}">
			                ...
			                <ul class="nav nav-pills pay" role="tablist">
			                  <li class="nav-item payment" role="presentation">
			                    <a class="nav-link active year" id="yearPrepaid-tab" data-bs-toggle="tab" href="#yearPrepaid" role="tab" aria-controls="yearPrepaid" aria-selected="true" data-value="{{$price}}">1 Year Prepaid</a>
			                  </li>
			                  <li class="nav-item" role="presentation">
			                    <a class="nav-link month" id="paidMonthly-tab" data-bs-toggle="tab" href="#paidMonthly" role="tab" aria-controls="paidMonthly" aria-selected="false" data-value="{{round($price/12)}}">Pay Monthly</a>
			                  </li>
			                </ul>
			                <div class="tab-content" id="payment_tab">
			                  ...
			                  <div class="tab-pane fade show active" id="yearPrepaid" role="tabpanel" aria-labelledby="yearPrepaid-tab">
			                    ...
			                    <div class="row gx-1 mt-3">
			                      ...
			                      <div class="col-3 text-end fw-bold total">${{$price}}</div>
			                    </div>
			                  </div>
			                  <div class="tab-pane fade" id="paidMonthly" role="tabpanel" aria-labelledby="paidMonthly-tab">
			                    <div class="row gx-1 mt-4 pt-3 border-bottom border-dark pb-4">
			                      ...
			                      <div class="col-3 text-end">${{round($price/12)}}</div>
			                    </div>
			                    <div class="row gx-1 mt-3">
			                      <div class="col-9 fw-bold">Total</div>
			                      <div class="col-3 text-end fw-bold total" id="total">${{round($price/12)}}</div>
			                    </div>
			                  </div>
			                </div>
			            </div>
                  	...
                  	<div class="tab-pane fade {{session('activeTab') == 'dual' ? 'show active' : ''}}" id="dual" role="tabpanel" aria-labelledby="dual-tab">
                  		<div class="form-wrap">
	                      	<div class="mb-5">Great choice! Tell us a bit more about yourself.</div>
		                    <form method="post" action="{{URL::asset('individual-post')}}" id="d_form">
		                    	@csrf
	                    ...
	                    <div class="tabs-style-1 mt-4">
			                ...
			                <ul class="nav nav-pills pay" role="tablist">
			                  <li class="nav-item payment" role="presentation">
			                    <a class="nav-link active year_d" id="yearPrepaid-tab" data-bs-toggle="tab" href="#yearPrepaid" role="tab" aria-controls="yearPrepaid" aria-selected="true" data-value="{{$price}}">1 Year Prepaid</a>
			                  </li>
			                  <li class="nav-item" role="presentation">
			                    <a class="nav-link month_d" id="paidMonthly-tab" data-bs-toggle="tab" href="#paidMonthly" role="tab" aria-controls="paidMonthly" aria-selected="false" data-value="{{$price}}">Pay Monthly</a>
			                  </li>
			                </ul>
			                <div class="tab-content" id="payment_tab">
			                  ...
			                  <div class="tab-pane fade" id="paidMonthly" role="tabpanel" aria-labelledby="paidMonthly-tab">
			                    ...
			                    <div class="row gx-1 mt-3">
			                      <div class="col-9 fw-bold">Total</div>
			                      <div class="col-3 text-end fw-bold total" id="total">${{$price}}</div>
			                    </div>
			                  </div>
			                </div>
			            </div>
	            ...
	            <!--        <div class="form-wrap">
	                    	...
	                    	<div class="tabs-style-1 mt-4">
				                ...
				                <?php
	                    			$price_1 = ($value['price_in_cents']/100);
	                    		?>
				                  <div class="tab-pane fade show active" id="yearPrepaid1" role="tabpanel" aria-labelledby="yearPrepaid-tab">
				                    <div class="row gx-1 mt-4 pt-3 border-bottom border-dark pb-4">
				                      ...
				                      <div class="col-3 text-end">${{($price_1 * 12)}}</div>
				                    </div>
				                    <div class="row gx-1 mt-3">
				                      <div class="col-9 fw-bold">Total</div>
				                      <div class="col-3 text-end fw-bold">${{($price_1 * 12)}}</div>
				                    </div>
				                  </div>
				                  <div class="tab-pane fade" id="paidMonthly1" role="tabpanel" aria-labelledby="paidMonthly-tab">
				                    <div class="row gx-1 mt-4 pt-3 border-bottom border-dark pb-4">
				                      ...
				                      <div class="col-3 text-end">${{($price_1)}}</div>
				                    </div>
				                    <div class="row gx-1 mt-3">
				                      <div class="col-9 fw-bold">Total</div>
				                      <div class="col-3 text-end fw-bold">${{($price_1)}}</div>
				                    </div>
				                  </div>
				                </div>
			            	</div>
	                ...
	                @else
                  	<div class="tab-pane fade {{session('activeTab') == 'gifting' ? 'show active' : ''}}" id="gifting" role="tabpanel" aria-labelledby="gifting-tab">
                    	<div class="form-wrap">
	                        ...
	                        <div class="pt-4 pb-3">
	                            ...
	                            <div class="form-check" data-bs-toggle="modal" data-bs-target="#radioNoModal">
		                            <input class="form-check-input" type="radio" name="no" value="no" id="no" checked>
                    	...
                    	<div class="tabs-style-1 mt-4">
                    		<?php
			                		$price_2 = ($value['price_in_cents']/100);
			                ?>
			                 <input type="hidden" name="product_price" id="pro_price_g" value="{{$price}}">
			                <h6 class="fw-bold mb-3">Select Your Payment Preference</h6>
			                <ul class="nav nav-pills" role="tablist">
				                <li class="nav-item" role="presentation">
				                    <a class="nav-link active year_g" id="yearPrepaid-tab" data-bs-toggle="tab" href="#yearPrepaid2" role="tab" aria-controls="yearPrepaid" aria-selected="true" data-value="{{$price_2}}">1 Year Prepaid</a>
				                </li>
			                  	<li class="nav-item" role="presentation">
			                    	<a class="nav-link month_g" id="paidMonthly-tab" data-bs-toggle="tab" href="#paidMonthly2" role="tab" aria-controls="paidMonthly" aria-selected="false" data-value="{{round($price_2 /12)}}">Pay Monthly</a>
			                  	</li>
			                </ul>
			                <div class="tab-content">
						        ...
						        <div class="tab-pane fade show active" id="yearPrepaid2" role="tabpanel" aria-labelledby="yearPrepaid-tab">
						            <div class="row gx-1 mt-4 pt-3 border-bottom border-dark pb-4">
							            <div class="col-9">
						              	...
						              	<div class="col-3 text-end">${{$price_2}}</div>
						            </div>
						            <div class="row gx-1 mt-3">
						              	<div class="col-9 fw-bold">Total</div>
						              	<div class="col-3 text-end fw-bold">${{$price_2}}</div>
						            </div>
						          </div>
							        <div class="tab-pane fade" id="paidMonthly2" role="tabpanel" aria-labelledby="paidMonthly-tab">
							            <div class="row gx-1 mt-4 pt-3 border-bottom border-dark pb-4">
							              	...
							              	<div class="col-3 text-end">${{round($price_2 / 12)}}</div>
							            </div>
							            <div class="row gx-1 mt-3">
							              	<div class="col-9 fw-bold">Total</div>
							              	<div class="col-3 text-end fw-bold">${{round($price_2 /12)}}</div>
							            </div>
							        </div>
						        </div>
		              		</div>
								            ...
								            <div class="modal-body">
								              ...
								              <div class="p-2 px-sm-4 pt-sm-4 pb-sm-2 mt-4 text-center">
								                <div class="mb-4 lh-1-7">Select the date you'd like their membership to begin. <br>This will also be the date they will receive their welcome email.</div>
								               	<input type="date" name="date"  class="mb-4 mx-auto datepicker-240" id="datepicker">
								              </div>
